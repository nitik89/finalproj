...
exports.processPayment = asyncErrorHandler(async (req, res, next) => {
    ...
    /* initialize an array */
    params["MID"] = "IGRyIQ09726752012503";
    params["WEBSITE"] = "WEBSTAGING";
    params["CHANNEL_ID"] ="WEB";
    params["INDUSTRY_TYPE_ID"] ="Retail";
    params["ORDER_ID"] = uuidv4();
    params["CUST_ID"] = "dgfg515451514451"
    ...
    let paytmChecksum = paytm.generateSignature(params, "Fv6EPBOAytlw3cxj");
...
exports.paytmResponse = (req, res, next) => {
    ...
    let isVerifySignature = paytm.verifySignature(req.body, "Fv6EPBOAytlw3cxj", paytmChecksum);
    if (isVerifySignature) {
        ...
        paytm.generateSignature(JSON.stringify(paytmParams.body), "Fv6EPBOAytlw3cxj").then(function (checksum) {
